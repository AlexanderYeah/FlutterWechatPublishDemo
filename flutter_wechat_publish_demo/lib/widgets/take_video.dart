...
import 'package:flutter_wechat_publish_demo/widgets/count_down.dart';
import 'package:wechat_assets_picker/wechat_assets_picker.dart';

class TakeVideoPage extends StatefulWidget {
  final CameraState cameraState;
  final Duration maxVideoDuration;
  TakeVideoPage(this.cameraState, this.maxVideoDuration, {super.key});
  @override
    ...
    widget.cameraState.captureState$.listen((event) async {
      if (event != null && event.status == MediaCaptureStatus.success) {
        ...
        final AssetEntity? asset =
            await PhotoManager.editor.saveVideo(file, title: fileTitle);
        // 删除临时文件
        await file.delete();
        ...
        child: Row(
          ...
          children: [
            ...
            if (widget.cameraState is VideoRecordingCameraState)
              CountDown(widget.maxVideoDuration, () {
